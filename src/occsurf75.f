...
c Translate aa name to one letter code
	   ...
	   if(ts.le.0.0) then
c	     print *, ' Error: residue has zero amino acid surface ', 
c     1       residen
	     go to 300
	   endif
...
c           write(6,'(a,5x,F9.2,5x,a)')'Sw:  ',sfdeaa,residen(1:8)
c           write(6,'(a,5x,F9.2,5x,a)')'St:  ',sfdeaai,residen(1:8)
c           write(6,'(a,7x,F9.2,5x,a)')'Ri:',
c     +               sfdeaa/sfdeaai,residen(1:8)
	endif
